...
export function LatestSermons() {
  ...
  return (
    <section id="sermons" className="bg-black text-white py-32">
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {isLoading ? (
            ...
            <div className="col-span-3 text-center text-white/40 py-20">
              등록된 설교가 없습니다.
            </div>
          ) : (
              ...
              >
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-start gap-4">
                    <h3 className="text-2xl group-hover:text-white/70 transition-colors line-clamp-2">
                      {post.title}
                    </h3>
