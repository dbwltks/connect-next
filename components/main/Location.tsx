  ...
  return (
    <section id="location" className="bg-white py-16">
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="mb-12">
          <span className="text-sm uppercase tracking-[0.3em] text-gray-400">Location</span>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-stretch">
          {/* Map */}
          <div className="relative overflow-hidden bg-gray-100 h-[350px] md:h-auto min-h-full">
            <iframe
              src={embedUrl}
              width="100%"
              height="100%"
          ...
          <div className="space-y-8">
            <div>
              <div className="text-xs uppercase tracking-[0.3em] text-gray-400 mb-4">Address</div>
              <div>
                <p className="text-2xl mb-2">Connect Church</p>
                <p className="text-xl text-gray-500">{address}</p>
              </div>
            </div>

            <div>
              <div className="text-xs uppercase tracking-[0.3em] text-gray-400 mb-4">Contact</div>
            ...
            <div className="pt-4 border-t border-gray-100">
              <div className="text-xs uppercase tracking-[0.3em] text-gray-400 mb-4">Directions</div>
            ...
            <div className="pt-4 border-t border-gray-100">
              <div className="text-xs uppercase tracking-[0.3em] text-gray-400 mb-4">Parking</div>
              <div className="space-y-3 text-gray-600">
                <p>40 Scollard St, Toronto, ON M5R 3S1</p>
                <p className="font-medium text-black">아파트 지하 주차장 입구 판넬의 녹색 버튼을 누르시면 됩니다. <br></br>주차장 입구는 건물 뒤 Scollard Street에 있습니다.</p>
              </div>
            </div>
          </div>
        </div>
