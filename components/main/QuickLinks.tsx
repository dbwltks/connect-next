...
import { BookOpen, Book, Church, DollarSign, Info, Heart } from "lucide-react";
      ...
      {showDonationPopup && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="relative bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-md w-full shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <h3 className="text-2xl font-bold mb-6 text-black dark:text-white">온라인 헌금</h3>

            {/* E-Transfer 정보 */}
            <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
              <h4 className="font-semibold text-black dark:text-white mb-2">E-Transfer</h4>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-white dark:bg-gray-800 p-3 rounded border border-gray-200 dark:border-gray-600">
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">수신자명</p>
            ...
            <div className="space-y-3 mb-6">
              <h4 className="font-semibold text-black dark:text-white mb-3">헌금 종류</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
                E-Transfer 메시지란에 아래 중 해당하는 헌금 종류를 영어로 적어주세요:
              </p>

              <div className="space-y-2">
                <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700 rounded">
                  <span className="text-sm text-black dark:text-white">주일헌금</span>
                  <span className="text-sm font-mono text-gray-600 dark:text-gray-300">Sunday Offering</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700 rounded">
                  <span className="text-sm text-black dark:text-white">감사헌금</span>
                  <span className="text-sm font-mono text-gray-600 dark:text-gray-300">Thanksgiving Offering</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700 rounded">
                  <span className="text-sm text-black dark:text-white">십일조</span>
                  <span className="text-sm font-mono text-gray-600 dark:text-gray-300">Tithe</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-gray-50 dark:bg-gray-700 rounded">
                  <span className="text-sm text-black dark:text-white">지정헌금</span>
                  <span className="text-sm font-mono text-gray-600 dark:text-gray-300">Designated Offering</span>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-gray-200 dark:border-gray-600">
              <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
                헌금해 주셔서 감사합니다. 하나님의 축복이 함께 하시길 기도합니다.
              </p>
            </div>
          </div>
        </div>
      ...
      {showPrayerPopup && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="relative bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-md w-full shadow-2xl">
            ...
            <h3 className="text-2xl font-bold mb-4 text-black dark:text-white">중보기도 요청</h3>

            <form className="space-y-4">
              <div>
                <label className="block text-sm font-medium mb-2 text-black dark:text-white">이름</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium mb-2 text-black dark:text-white">기도 제목</label>
                <textarea
                  rows={4}
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-black dark:text-white"
